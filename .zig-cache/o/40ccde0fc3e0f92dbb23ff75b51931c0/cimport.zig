...
pub const struct_Vector2 = extern struct {
    ...
    pub const DrawCircleGradient = __root.DrawCircleGradient;
    ...
    pub const DrawTriangleGradient = __root.DrawTriangleGradient;
    ...
    pub const GetSplinePointBezierQuadratic = __root.GetSplinePointBezierQuadratic;
...
pub const struct_Image = extern struct {
    ...
    pub const ImageDrawRectangleLinesEx = __root.ImageDrawRectangleLinesEx;
    pub const ImageDrawTriangle = __root.ImageDrawTriangle;
    pub const ImageDrawTriangleGradient = __root.ImageDrawTriangleGradient;
...
pub const SaveFileDataCallback = ?*const fn (fileName: [*c]const u8, data: ?*const anyopaque, dataSize: c_int) callconv(.c) bool;
...
pub extern fn SaveFileData(fileName: [*c]const u8, data: ?*const anyopaque, dataSize: c_int) bool;
...
pub extern fn DrawCircleGradient(center: Vector2, radius: f32, inner: Color, outer: Color) void;
...
pub extern fn ImageColorContrast(image: [*c]Image, contrast: c_int) void;
...
pub extern fn ImageDrawRectangleLines(dst: [*c]Image, posX: c_int, posY: c_int, width: c_int, height: c_int, color: Color) void;
...
pub extern fn DrawCylinderWiresEx(startPos: Vector3, endPos: Vector3, startRadius: f32, endRadius: f32, slices: c_int, color: Color) void;
pub extern fn DrawCapsule(startPos: Vector3, endPos: Vector3, radius: f32, rings: c_int, slices: c_int, color: Color) void;
pub extern fn DrawCapsuleWires(startPos: Vector3, endPos: Vector3, radius: f32, rings: c_int, slices: c_int, color: Color) void;
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /snap/zig/16117/lib/compiler/aro/include/stdarg.h:12:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /snap/zig/16117/lib/compiler/aro/include/stdarg.h:14:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /snap/zig/16117/lib/compiler/aro/include/stdarg.h:15:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /snap/zig/16117/lib/compiler/aro/include/stdarg.h:18:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /snap/zig/16117/lib/compiler/aro/include/stdarg.h:22:9
...
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // /home/leo/zig/GameBoy/.zig-cache/o/c7cd99ba0bc92327aca50c0bcc0c06f5/raylib.h:132:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // /home/leo/zig/GameBoy/.zig-cache/o/c7cd99ba0bc92327aca50c0bcc0c06f5/raylib.h:135:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // /home/leo/zig/GameBoy/.zig-cache/o/c7cd99ba0bc92327aca50c0bcc0c06f5/raylib.h:138:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // /home/leo/zig/GameBoy/.zig-cache/o/c7cd99ba0bc92327aca50c0bcc0c06f5/raylib.h:141:13
