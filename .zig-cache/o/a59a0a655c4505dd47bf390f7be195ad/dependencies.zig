pub const packages = struct {
    ...
    pub const @"N-V-__8AAJl1DwBezhYo_VE6f53mPVm00R-Fk28NPW7P14EQ" = struct {
        pub const build_root = "/home/leo/zig/GameBoy/zig-pkg/N-V-__8AAJl1DwBezhYo_VE6f53mPVm00R-Fk28NPW7P14EQ";
        pub const deps: []const struct { []const u8, []const u8 } = &.{};
    };
    pub const @"N-V-__8AALShqgXkvqYU6f__FrA22SMWmi2TXCJjNTO1m8XJ" = struct {
        pub const available = false;
    };
    pub const @"raylib-6.0.0-whq8uOpvLwUL44Y66PxQiBMjWf6fjPFg9Ro1Su2ezoOa" = struct {
        pub const build_root = "/home/leo/zig/GameBoy/zig-pkg/raylib-6.0.0-whq8uOpvLwUL44Y66PxQiBMjWf6fjPFg9Ro1Su2ezoOa";
        pub const build_zig = @import("raylib-6.0.0-whq8uOpvLwUL44Y66PxQiBMjWf6fjPFg9Ro1Su2ezoOa");
        pub const deps: []const struct { []const u8, []const u8 } = &.{
    ...
    pub const @"zemscripten-0.2.0-dev-sRlDqApRAACspTbAZnuNKWIzfWzSYgYkb2nWAXZ-tqqt" = struct {
        pub const build_root = "/home/leo/zig/GameBoy/zig-pkg/zemscripten-0.2.0-dev-sRlDqApRAACspTbAZnuNKWIzfWzSYgYkb2nWAXZ-tqqt";
...
pub const root_deps: []const struct { []const u8, []const u8 } = &.{
    .{ "raylib", "raylib-6.0.0-whq8uOpvLwUL44Y66PxQiBMjWf6fjPFg9Ro1Su2ezoOa" },
};
